                                    ...
                                    <div class="action-form">
                                        ...
                                        <div class="acepted-payment-methods">
                                            <ul class="payment-methods">
                                                <li ><img src="assets/images/payment_card/nogod.png" alt="" width="51" height="36"></li>
                                                <li><img src="assets/images/payment_card/bkash.png" alt="" width="51" height="36"></li>
                                                <li><img src="assets/images/payment_card/rocket.png" alt="" width="51" height="36"></li>
                                                <li><img src="assets/images/payment_card/islamic_bank.png" alt="" width="51" height="36"></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>

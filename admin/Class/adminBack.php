...
$address=$data['address'];
 ...
 $query = " INSERT INTO `payment`(`name`,  `gender`, `email`, `amounts`, `trans_id`, `phone`, `District`, `address`) VALUES ('$name','$gender','$email','$amounts','$trans_id','$phone','$district','$address')";
